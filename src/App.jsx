...
function App() {
  ...
  return (
    <>
      <div className="card">
        <center><h1><font size="10">Carpe Diem.</font></h1></center>
        {todos.map(todo => (
        ...
        <div className="group">
          <IconButton aria-label="delete" onClick={addTodo} sx={{'width': 'fit-content' , 
...
function Todo({todo , onUpdate , renderAgain}) {
    ...
    return <>
      ...
      <Checkbox onClick={handleCheck} sx={{'& .MuiSvgIcon-root': {color: 'black',}}}/>
      <IconButton aria-label="delete" onClick={handleDelete} sx={{'& .MuiSvgIcon-root': {color: 'black',}}}>
        <DeleteIcon />
      </IconButton>
    </>
}
